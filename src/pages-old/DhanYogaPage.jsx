...
const WEALTH_PATTERN = /dhan|wealth|lakshmi|kubera|vasumati|parvata|artha|prosper|riches|affluen|income|money/i;
...
export default function DhanYogaPage({ service }) {
