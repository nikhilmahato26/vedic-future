        ...
        {activeNakshatra && (
          <div className="mb-10 space-y-6">
            ...
            <Panel className="flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
              ...
              <Link to="/muhurat" className="inline-flex shrink-0 items-center gap-2 rounded-full border border-coral/50 px-5 py-2.5 text-sm font-medium text-coral transition hover:bg-coral/10">
